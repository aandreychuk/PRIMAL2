...
if __name__ == "__main__":
    ...
    parser.add_argument("-n", "--num_agents", default=[4, 8, 16], help="number of agents in the env")
    parser.add_argument("-s", "--env_size", default=[80], help="env size")
    parser.add_argument("-d", "--obs_dense", default=[0.3 + 0.15 * i for i in range(3)],
                        help="obstacle density of the env")
    parser.add_argument("-w", "--wall_component", default=[6, 12], help="average length of each wall")
